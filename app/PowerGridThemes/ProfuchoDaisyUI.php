...
class ProfuchoDaisyUI extends DaisyUI
{
    ...
    public function table(): array
    {
        return [
            'layout' => [
                'base' => 'p-0 align-middle inline-block min-w-full w-full sm:px-0 lg:px-0',
                'div' => 'rounded-t-lg relative border-x border-t border-base-300 shadow-xs bg-base-100',
            ...
            'body' => [
                ...
                'tbodyEmpty' => '',
                'tr' => '',
                'td' => 'border-b-2 border-primary/10 py-1',
                'tdEmpty' => '',
                'tdSummarize' => '',
                'trSummarize' => '',
                'tdFilters' => '',
